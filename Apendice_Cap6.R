...
importa.dat <- read.table("importacao.txt", header = TRUE)
importa.dat$logIM <- log(importa.dat$IM)
importa.dat$invIM <- 1/importa.dat$IM

## Fig. 6.7
pdf("importadisp.pdf", w = 12, h = 8)
par(mfrow = c(2,3), cex.lab = 1.6, cex.axis = 1.4)
plot(IM ~ TCI, data = importa.dat, cex = .8,
     xlab = "Taxa de câmbio", ylab = "Importações brasileiras")
plot(logIM ~ TCI, data = importa.dat, cex = .8,
     xlab = "Taxa de câmbio", ylab = "log(Importações brasileiras)")
plot(invIM ~ TCI, data = importa.dat, cex = .8,
     xlab = "Taxa de câmbio", ylab = "1/Importações brasileiras")
plot(IM ~ RN, data = importa.dat, cex = .8,
     xlab = "Renda nacional", ylab = "Importações brasileiras")
plot(logIM ~ RN, data = importa.dat, cex = .8,
     xlab = "Renda nacional", ylab = "log(Importações brasileiras)")
plot(invIM ~ RN, data = importa.dat, cex = .8,
     xlab = "Renda nacional", ylab = "1/Importações brasileiras")
dev.off()

## Ajuste dos modelos
mod1 <- lm(IM ~ TCI + RN, data = importa.dat)
mod2 <- lm(IM ~ TCI + RN + I(TCI^2) + I(RN^2), data = importa.dat)
mod3 <- lm(log(IM) ~ TCI + RN, data = importa.dat)
mod4 <- glm(IM ~ TCI + RN, family = gaussian(link = log), data = importa.dat)
...
ffun <- function(y.) glm(y. ~ TCI + RN,
                         family = gaussian(link = log), 
                         start = coef(mod4), data = importa.dat)
m4hnp <- hnp(mod4, half = FALSE, newclass = TRUE,
             diagfun = dfun, simfun = sfun, fitfun = ffun)

pdf("hnp_importa_m134.pdf", w = 9, h = 3)
par(mfrow = c(1,3), cex.lab = 1.4, cex.main = 1.8, cex.axis = 1.2)
plot(m1hnp, pch = 16, cex = .6, xlab = "Quantis teóricos", ylab = "Resíduos estudentizados", main = "M1")
plot(m3hnp, pch = 16, cex = .6, xlab = "Quantis teóricos", ylab = "Resíduos estudentizados", main = "M3")
plot(m4hnp, pch = 16, cex = .6, xlab = "Quantis teóricos", ylab = "Resíduos estudentizados", main = "M4")
dev.off()

r1 <- rstudent(mod1)

pdf("importafittedNident.pdf", w = 6, h = 6)
par(mfrow = c(2,2), cex.lab = 1.4, cex.axis = 1.2, cex.main = 1.6, cex = .5)
plot(fitted(mod1) ~ importa.dat$IM, xlab = "Valores observados", ylab = "Valores ajustados", main = "Normal(identidade)")
plot(r1 ~ fitted(mod1), xlab = "Valores ajustados", ylab = "Resíduos", main = "Normal(identidade)")
plot(r1 ~ importa.dat$TCI, xlab = "TCI", ylab = "Resíduos", main = "Normal(identidade)")
plot(r1 ~ importa.dat$RN, xlab = "RN", ylab = "Resíduos", main = "Normal(identidade)")
dev.off()
...
mod7 <- glm(IM ~ TCI + RN,
            ...
            data = importa.dat)
mod8 <- glm(IM ~ TCI + RN + I(RN^2),
            family = Gamma(link = "inverse"),
            data = importa.dat)
mod8.poly <- glm(IM ~ TCI + poly(RN, 2),
                 family = Gamma(link = "inverse"),
                 data = importa.dat)
summary(mod8.poly)

m5hnp <- hnp(mod5, half = FALSE)
m6hnp <- hnp(mod6, half = FALSE)
m7hnp <- hnp(mod7, half = FALSE)
m8hnp <- hnp(mod8, half = FALSE)

pdf("hnp_importa_m567.pdf", w = 9, h = 6)
par(mfrow = c(2,3), cex.lab = 1.4, cex.main = 1.8, cex.axis = 1.2)
plot(importa.dat$IM, fitted(mod5), xlab = "Valores observados", ylab = "Valores ajustados", main = "M5", cex = .6)
plot(importa.dat$IM, fitted(mod6), xlab = "Valores observados", ylab = "Valores ajustados", main = "M6", cex = .6)
plot(importa.dat$IM, fitted(mod7), xlab = "Valores observados", ylab = "Valores ajustados", main = "M7", cex = .6)
plot(m5hnp, pch = 16, cex = .6, xlab = "Quantis teóricos", ylab = "Resíduos estudentizados", main = "M5")
plot(m6hnp, pch = 16, cex = .6, xlab = "Quantis teóricos", ylab = "Resíduos estudentizados", main = "M6")
plot(m7hnp, pch = 16, cex = .6, xlab = "Quantis teóricos", ylab = "Resíduos estudentizados", main = "M7")
dev.off()

pdf("hnp_importa_m8.pdf", w = 9, h = 3)
par(mfrow = c(1,3), cex.lab = 1.4, cex.main = 1.8, cex.axis = 1.2)
plot(importa.dat$IM, fitted(mod8), xlab = "Valores observados", ylab = "Valores ajustados", main = "M8", cex = .6)
plot(fitted(mod8), rstudent(mod8), xlab = "Valores ajustados", ylab = "Resíduos", main = "M8", cex = .6)
plot(m8hnp, pch = 16, cex = .6, xlab = "Quantis teóricos", ylab = "Resíduos estudentizados", main = "M8")
dev.off()
